...
public class UserService implements UserServiceImpl {
    ...
    public ResponseEntity<String> loginUser(LoginDTO loginDTO) {
        Optional<User> usuarioOptional = userRepository.findByUserNameAndPassword(loginDTO.getUsuario(),loginDTO.getPassword());
        if (usuarioOptional.isPresent()) {
            return ResponseEntity.ok("Inicio de sesión exitoso. Bienvenido, " + usuarioOptional.get().getName());
        } else {
