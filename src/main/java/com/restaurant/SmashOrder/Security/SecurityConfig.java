    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/login", "/api/auth/register","/api/password/**").permitAll()
                        // ✅ Users
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/orders/paginated").hasAnyRole("ADMIN", "EMPLOYEE")
                        .requestMatchers(HttpMethod.GET, "/api/orders/without-invoice").hasAnyRole("ADMIN", "EMPLOYEE")
                        .requestMatchers(HttpMethod.GET, "/api/orders/count").hasAnyRole("ADMIN", "EMPLOYEE")
